...
namespace HealthyCron.Data.Interfaces
{
    public interface IMonitorRepository
    {
        ...
        Task<IEnumerable<MonitorPing>> GetPingsByDateRangeAsync(Guid monitorId, DateTime startDate, DateTime endDate);
        ...
        Task<IEnumerable<HealthyCron.Models.DTOs.MonthlyUptimeDto>> GetMonthlyStatsAsync(Guid monitorId);
    }
}
